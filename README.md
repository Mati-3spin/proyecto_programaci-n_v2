...
Imagen original
      │
      ▼
Muestreo de las 4 esquinas → Color promedio del fondo
      │
      ▼
Distancia euclidiana píxel a píxel vs. color de fondo
      │
      ▼
Umbral (45.0) → Máscara binaria del objeto
      │
      ▼
Combinación matricial: objeto original + fondo nuevo
      │
      ▼
Imagen resultante
